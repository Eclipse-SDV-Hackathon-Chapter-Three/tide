class Topics:
    VEHICLE_ADAS_ACTOR_SEEN = "vehicle/adas-actor/seen"
    VEHICLE_ADAS_ACTOR_EVENT_CREATED = "vehicle/adas-actor/event_created"
    ...
    FRONTEND_NOTIFICATION_UPDATE= "vehicle/infotainment/notification_update"
